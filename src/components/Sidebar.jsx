import { RiDashboardLine, RiTeamLine, RiUser3Line, RiFileChartLine, RiLogoutBoxRLine } from "react-icons/ri";
...
export default function Sidebar({ userRole = "staff", onLogout }) {
    ...
    return (
        <aside id="sidebar-container" className="w-64 min-h-screen bg-[#1A1A1A] border-r border-[#2D2D2D] p-8 flex flex-col sticky top-0 shadow-2xl font-instrument">
            ...
            {/* Bagian Bawah: Info Akun & Tombol Logout */}
            <div id="sidebar-footer" className="mt-auto bg-[#252525] p-5 rounded-[24px] relative overflow-hidden border border-[#333]">
